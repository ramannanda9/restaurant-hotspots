...
// (1110,(((3251,7204),34968.3),(9,1827,34.5)))
// (6915,(((410,175),6579.49),(1,170,4.0)))
// (3525,(((1090,1497),9503.609),(2,198,6.5)))
// (3630,(((772,1789),7400.5),(13,5548,49.5)))
// (2670,(((1280,1661),10937.0),(4,1185,16.5)))
// (795,(((215,54),3121.0),(3,160,12.5)))
// (5325,(((1271,518),14521.5),(3,2046,12.0)))
// (1740,(((42,9),607.0),(2,307,7.0)))
// (4755,(((854,423),10265.5),(1,5,3.5)))
// (1350,(((2500,1999),25022.3),(10,2777,39.5)))

// (grid_id, (((dropoff_cnt, pickup_cnts), total fare) , (number of places, total review cnts, sum of ratings)
